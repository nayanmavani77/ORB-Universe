...
from .settings import FORWARD, REVERSE, ReversalSettings
...
@dataclass
class GridItem:
    """One point on the grid, with the config that runs it."""
    run_name: str
    cfg: AppConfig
                            ...
                            for cap in trade_caps:
                                for direction in directions:
                                    ...
                                    run_name = (
                                        ...
                                        f"SL{_tag(mult)}_"
                                        f"{settings.run_name().split('_')[-1]}_"
                                    ...
                                    out.append(GridItem(
                                        ...
                                        settings=settings, engine="reversal",
                                        session=session,
