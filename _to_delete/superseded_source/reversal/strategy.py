...
from ..breakout.strategy import RangeBreakoutStrategy
from .settings import ANCHOR_MIRROR, ReversalSettings


class ReversalStrategy(RangeBreakoutStrategy):
    ...
    def __init__(self, cfg, broker, store=None, logger=None):
        ...
        self.settings: ReversalSettings = settings_of(cfg, ReversalSettings)
